...
//        testCases.add(Triple.of(new Counter(), "Win 10 IE 11",              "Mozilla/5.0 (Windows NT 10.0; WOW64; Trident/7.0; rv:11.0) like Gecko"));
        ...
        try {
            BufferedReader reader = new BufferedReader(new InputStreamReader(getClass().getClassLoader().getResourceAsStream("ua_past_7_20191209_brand.csv")));
            String line;
            int count = 0;
            while ((line = reader.readLine()) != null) {
                String[] array = line.split(",");
                testCases.add(Triple.of(new Counter(), String.valueOf(++count), array[0]));
            }
        } catch (IOException e) {
